 ...
 * 
 */
package com.android.settings.creeperos;
...
private static final String RR_ROM_SHARE = "share";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSiteUrl = findPreference("creeper_website");
        mSourceUrl = findPreference("creeper_source");
        mDonateUrl = findPreference("creeper_donate");
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mSiteUrl) {
            launchUrl("http://CreeperOS.github.io/");
        } else if (preference == mSourceUrl) {
            launchUrl("https://github.com/CreeperOS");
        } else if (preference.getKey().equals(CREEPER_ROM_SHARE)) {
